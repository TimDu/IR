 ...
 * File: Stemmer.java
 * File Description:
 * An implementation of a stemmer from 
 * http://tartarus.org/martin/PorterStemmer/java.txt
 * 
 * Per the discussion thread "Query on stemming" from UB learns Nikhil stated
 * we could copy/paste and fit this implementation to meet our needs. Below
 * is the header reproduced for the original file followed by its 
 * implementation.  
 * 
 *****************************************************************************/
...
public class Stemmer {
	...
	private final void step5() {
		...
		case 'n':
			...
			return;
		case 'o':
			if (ends("ion") && j >= 0 && (b.get(j) == 's' || b.get(j) == 't'))
				break;
			/* j >= 0 fixes Bug 2 */
			if (ends("ou"))
				break;
